    ...
    <form class="row g-3 needs-validation shadow-lg p-3 mb-5 bg-body rounded" action="<?php echo e(route('login')); ?>" method="POST">
        ...
        <div class="col-md-10">
            ...
            <div class="input-group has-validation">
                ...
                <input name="email" id="email" type="email" class="form-control"  aria-describedby="emailHelp" placeholder="Введите email" required value=<?php echo e(old('email')); ?> >
            </div><br>
...
<?php /**PATH C:\Users\maksi\PhpstormProjects\Gos_Podgotovka\resources\views/login.blade.php ENDPATH**/ ?>